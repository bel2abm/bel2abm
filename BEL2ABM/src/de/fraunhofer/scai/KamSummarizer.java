...
public class KamSummarizer {
	...
	private static String USAGE = "BEL2ABM \n"
			+ "-beldoc [path to BEL document]"; 
	...
	public static void main(String[] args) {
		...
		//beldoc = new BELDocument(getArg(args, "-beldoc"));
		//ArrayList<BELStatement> belstatements = beldoc.getAllStatements();
